...
namespace EKG_Project.Modules.QT_Disp
{
    public class QT_Disp_Data : ECG_Data
    {
        ...
        public QT_Disp_Data(List<Tuple<String, double>> QT_Disp_local, List<Tuple<String, double>> QT_Mean, List<Tuple<String, double>> QT_Std,  List<Tuple<String, List<int>>> T_End_local, List<Tuple<String, List<double>>> QT_Intervals)
        {
