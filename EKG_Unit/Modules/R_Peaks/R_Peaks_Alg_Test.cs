...
namespace EKG_Unit.Modules.R_Peaks
{
    ...
    public class R_Peaks_Alg_Test
    {
        ...
        public void IntegrationTest()
        {
            ...
            double[] resultArray = { 0.2222, 0.2222, 0.3333, 0.1111, 1.0000, 0.6667, 0.4444, 0.5556, 0.4444, 0.8889 };
        ...
        {
            double[] testArray = { 2, 0, 1, -2, 8, -3, 0, 1, 0, 2 };
            double[] resultArray = { 0, 0, 0.3333, 0.1111, 1.0000, 0.6667, 0.4444, 0.5556, 0.4444, 0.8889 };
