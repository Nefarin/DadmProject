...
namespace EKG_Unit.Modules.Heart_Axis
{
    ...
    public class Heart_Axis_Alg_Test
    {
        ...
        [TestMethod]
        [Description("LeastSquaresMethod - A")] 
        ...
        [TestMethod]
        [Description("LeastSquaresMethod - B")]
        ...
        [TestMethod]
        [Description("LeastSquaresMethod - C")]
        ...
        [TestMethod]
        [Description("ReadingAmplitudes - checks if works properly")]
        ...
        [TestMethod]
        [Description("IandII - checks if works properly")]
